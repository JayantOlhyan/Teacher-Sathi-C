...
export default function NotFound() {
  return (
    <html lang="en">
      ...
      <body className="min-h-screen bg-[#F7F9F4] text-[#1C2B1C] flex flex-col font-sans relative overflow-x-hidden antialiased">
        ...
        {/* Header */}
        <header className="sticky top-0 z-50 flex items-center justify-between h-[76px] px-[clamp(20px,5vw,48px)] bg-[#F7F9F4]/80 backdrop-blur-md border-b border-[#DCE4D7] shrink-0">
          <div className="flex items-center gap-3">
            <img src="/assets/owl-mascot-green.png" alt="TeacherSathi owl" className="h-10 w-10 object-contain" />
            <span className="font-extrabold text-2xl tracking-tight text-[#166534]">
              Teacher<b className="text-[#1C2B1C]">Sathi</b>
            </span>
          </div>
          <a href="/login" className="font-bold text-sm text-[#166534] border-[1.5px] border-[#166534] rounded-full px-6 py-2.5 hover:bg-[#166534] hover:text-white transition-all duration-200">
            Sign In
          </a>
        </header>

        {/* Main Content */}
        <main className="flex-1 flex flex-col items-center justify-center text-center px-[clamp(20px,5vw,48px)] py-10 gap-2 relative z-10">
        ...
        {/* Footer */}
        <footer className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-4 px-[clamp(20px,5vw,48px)] py-5 bg-[#EEF2EA] border-t border-[#DCE4D7]">
